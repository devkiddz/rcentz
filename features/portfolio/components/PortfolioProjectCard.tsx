...
function PortfolioEngagementMeta({ project }: { project: PortfolioProject }) {
  ...
  const metrics = [
    { label: 'Views', value: project.analytics.views, icon: Eye },
    { label: 'Likes', value: project.reactions.like, icon: ThumbsUp },
    { label: 'Reactions', value: project.analytics.reactions, icon: Heart },
    { label: 'Comments', value: project.analytics.comments, icon: MessageCircle }
  ];
...
function PortfolioProjectSignals({
  ...
  const activeReactionTypes = [
    { label: 'Love', value: project.reactions.love, icon: Heart },
    { label: 'Fire', value: project.reactions.fire, icon: Flame },
    { label: 'Shares', value: project.analytics.shares, icon: Share2 }
    ...
    <div className={compact ? 'mt-5 space-y-3' : 'mt-8 space-y-3'}>
      ...
      <div className="grid grid-cols-2 gap-2">
        <motion.div
          ...
          transition={{ duration: 0.42, delay: reduceMotion ? 0 : 0.18 }}
            ...
            <div className="mt-3 flex flex-wrap gap-2">
              {visibleCredits.map((credit, creditIndex) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ duration: 0.32, delay: reduceMotion ? 0 : 0.22 + creditIndex * 0.05 }}
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, amount: 0.45 }}
          transition={{ duration: 0.42, delay: reduceMotion ? 0 : 0.24 }}
            ...
            <div className="mt-3 space-y-2">
              {visibleSuggestions.map((suggestion, suggestionIndex) => (
                <motion.div
                  ...
                  whileInView={{ opacity: 1, x: 0 }}
                  viewport={{ once: true }}
                  transition={{ duration: 0.34, delay: reduceMotion ? 0 : 0.28 + suggestionIndex * 0.06 }}
...
export function PortfolioProjectCard({ project, index, featured = false }: PortfolioProjectCardProps) {
  ...
  if (featured) {
    return (
      <motion.article
        ...
        className="group relative overflow-hidden rounded-[30px] border border-border bg-background/65 backdrop-blur-sm transition-[background-color,border-color] hover:border-border-strong hover:bg-surface-raised/60">
        <div className="grid md:grid-cols-[0.88fr_1.12fr]">
          <div className="relative flex flex-col p-6 sm:p-8 lg:p-9">
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              transition={{ duration: 0.4, delay: reduceMotion ? 0 : 0.22 }}
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              transition={{ duration: 0.4, delay: reduceMotion ? 0 : 0.34 }}
              ...
              {project.liveUrl ? (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex h-10 items-center gap-2 rounded-full bg-primary px-4 text-[11px] font-medium text-primary-foreground transition-opacity hover:opacity-85">
                  View live
          ...
          <motion.div
            ...
            transition={{ duration: 0.62, delay: reduceMotion ? 0 : 0.08, ease: [0.22, 1, 0.36, 1] }}
  ...
  return (
    <motion.article
      ...
      transition={{ duration: 0.52, delay: reduceMotion ? 0 : introDelay, ease: [0.22, 1, 0.36, 1] }}
      whileHover={reduceMotion ? undefined : { y: -4 }}
      className="group relative flex min-h-[610px] flex-col overflow-hidden rounded-[26px] border border-border bg-background/62 backdrop-blur-sm transition-[background-color,border-color] hover:border-border-strong hover:bg-surface-raised/70">
      <motion.div
        initial={reduceMotion ? false : { opacity: 0, scale: 1.01 }}
        whileInView={{ opacity: 1, scale: 1 }}
        viewport={{ once: true }}
        transition={{ duration: 0.55, delay: reduceMotion ? 0 : introDelay + 0.05 }}
      ...
      <div className="relative flex flex-1 flex-col p-5">
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.35, delay: reduceMotion ? 0 : introDelay + 0.08 }}
        ...
        <motion.h3
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.4, delay: reduceMotion ? 0 : introDelay + 0.12 }}
        ...
        <motion.p
          ...
          whileInView={{ opacity: 1 }}
          viewport={{ once: true }}
          transition={{ duration: 0.4, delay: reduceMotion ? 0 : introDelay + 0.15 }}
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.38, delay: reduceMotion ? 0 : introDelay + 0.18 }}
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.38, delay: reduceMotion ? 0 : introDelay + 0.26 }}
