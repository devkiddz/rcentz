...
export function BusinessSystemsStory() {
  return (
    <div className="grid items-center gap-10 sm:gap-12 lg:grid-cols-[0.82fr_1.18fr] lg:gap-12">
      <div className="min-w-0 max-w-[510px] text-left lg:pr-2">
        ...
        <h2 className="mt-4 max-w-[500px] text-[2.05rem] font-semibold leading-[0.98] tracking-[-0.055em] text-foreground sm:mt-5 sm:text-[3rem] lg:text-[3.8rem]">
          Put your operations in one system.
        </h2>

        <p className="mt-4 max-w-[475px] text-[12px] leading-6 text-muted sm:mt-5 sm:text-[14px] sm:leading-7">
          Rcentz builds structured business systems that bring users, records, workflows, reporting and daily
          operations into one connected application.
        </p>
