...
export function WebDevelopmentStory() {
  return (
    <div className="grid items-center gap-10 sm:gap-12 lg:grid-cols-[0.88fr_1.12fr] lg:gap-12">
      <div className="min-w-0 max-w-[540px] text-left lg:pr-2">
        ...
        <h1 className="mt-4 max-w-[520px] text-[2.15rem] font-semibold leading-[0.98] tracking-[-0.055em] text-foreground sm:mt-5 sm:text-[3.15rem] lg:text-[4.2rem]">
          Websites built to work for your business.
        </h1>

        <p className="mt-4 max-w-[500px] text-[12px] leading-6 text-muted sm:mt-5 sm:text-[14px] sm:leading-7">
          From focused landing pages and professional business websites to complete custom web applications,
          Rcentz builds responsive digital experiences around your brand, customers and real business
          workflows.
        </p>
