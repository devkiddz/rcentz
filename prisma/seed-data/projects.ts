...
export type SeedProjectVisibility = "PUBLIC" | "UNLISTED";
...
export type SeedUpdateVisibility = "INTERNAL" | "CLIENT" | "PUBLIC";
...
export const projectSeedManifest: SeedProjectManifest[] = [
  {
    ...
    portfolio: {
      ...
      liveUrl: "https://ajlojik.vercel.app",
      repositoryUrl: "https://github.com/devkiddz/AJlojik",
      featured: true,
    ...
    milestones: [
      {
        ...
        gitCommitSha: "19f6d9f7d63340b74acf7c791304b364f6428564",
        completionNotes:
          "Git milestone: feat: complete cinematic AJ Logik storefront homepage.",
      },
      {
        title: "Multi-Vendor Commerce Operations",
        slug: "multi-vendor-commerce-operations",
        description:
        ...
        gitCommitSha: "179159dd47c795b177eb3f5abb8c501c04eb1bbf",
        completionNotes:
          "Git milestone: feat: stabilize operations and multi-vendor commerce.",
      },
      {
        title: "Commerce Intelligence Foundation",
        slug: "commerce-intelligence-foundation",
        description:
        ...
        gitCommitSha: "f403d3f09dd991942e1df80bba8dbc05ef105734",
        completionNotes:
      ...
      },
      {
        ...
        sortOrder: 4,
        completedAt: "2026-08-02",
        gitCommitSha: "133ad46889b0d12cd480bb0865d9d92ea4fc2a90",
        completionNotes:
          "Git milestone: merge: complete MS11 communication and support.",
      },
      {
        title: "Living Intelligence Journeys",
        slug: "living-intelligence-journeys",
        description:
        ...
        gitCommitSha: "0f7f00f258fe3fc72837845a8bf33cd1ae57d73f",
        completionNotes:
          "Git milestone: feat(ai): complete MS12 living intelligence journey system.",
      },
      {
        title: "Product and Discovery Experience",
        slug: "product-and-discovery-experience",
        description:
        ...
        sortOrder: 6,
        completedAt: "2026-08-05",
        gitCommitSha: "a5cf2901f8dd76987076649dba2c3dff72b5f4c2",
        completionNotes:
          "Git milestone: feat: finalize product page and discovery hub navigation.",
      },
      {
        title: "Production Runtime Stabilization",
        slug: "production-runtime-stabilization",
        description:
        ...
        gitCommitSha: "be05b89153c47ab6da8ba91d9e4b7f3378184897",
        completionNotes:
...

  {
    ...
    completedAt: "2026-08-07T23:16:54+01:00",
    portfolio: {
      tagline:
      ...
      liveUrl: "https://shelsea.vercel.app",
      repositoryUrl: "https://github.com/devkiddz/shelsea-commerce",
      featured: true,
    ...
    milestones: [
      {
        title: "Commerce Foundation Adaptation",
        slug: "commerce-foundation-adaptation",
        description:
      ...
      {
        title: "Single-Vendor Storefront Finalization",
        slug: "single-vendor-storefront-finalization",
        description:
        ...
        sortOrder: 3,
        completedAt: "2026-08-07T23:16:54+01:00",
        gitCommitSha: "dab15e4dc5e8222a4ee02654e7ca256cf5b42a3d",
        completionNotes:
          "Git milestone explicitly records: feat: finalize Shelsea single-vendor storefront.",
      },
      {
        title: "Responsive Product Polish",
        slug: "responsive-product-polish",
        description:
        ...
        sortOrder: 4,
        completedAt: "2026-08-07",
        gitCommitSha: "9b56a4e2a2841821e2d8bc3d043b932fc7934bfa",
      },
    ],
  },

  {
    ...
    portfolio: {
      ...
      repositoryUrl: "https://github.com/devkiddz/waffi-market",
      featured: false,
    },
    technologies: [
      { name: "Next.js", slug: "nextjs" },
    ...
    milestones: [
      {
        title: "Inherited Commerce Foundation",
        slug: "inherited-commerce-foundation",
        description:
      ...
      {
        title: "Waffi Marketplace Differentiation",
        slug: "waffi-marketplace-differentiation",
        description:
...

  {
    ...
    portfolio: {
      ...
      liveUrl: "https://job-rcentz.vercel.app",
      repositoryUrl: "https://github.com/devkiddz/JobRcentz",
      featured: true,
    ...
    milestones: [
      {
        title: "Role-Based Onboarding Foundation",
        slug: "role-based-onboarding-foundation",
        description:
        ...
        gitCommitSha: "2030743e530ee54a6377d9847b947c064622310a",
        completionNotes:
          "Git milestone: feat: complete Job Rcentz onboarding foundation.",
      },
      {
        title: "Employer Dashboard and Company Profile",
        slug: "employer-dashboard-company-profile",
        description:
        ...
        gitCommitSha: "a7585a717339bca5e608f84ad5ee47773904e427",
        completionNotes:
      ...
      },
      {
        ...
        gitCommitSha: "6ce7014b65f119c4baedb9fcaf73f04ea80072e9",
        completionNotes:
      ...
      },
      {
        ...
        gitCommitSha: "5c7d93cf484dace10279765fef3f8b651c0acf9d",
        completionNotes:
          "Git milestone: Complete notification candidate and messaging phase.",
      },
      {
        title: "Job Seeker Dashboard and Portfolio",
        slug: "job-seeker-dashboard-and-portfolio",
        description:
        ...
        gitCommitSha: "8e902e709f31950fd7a809c694440663c0aab7de",
        completionNotes:
          "This checkpoint records the tested application state after the candidate dashboard and portfolio work was integrated.",
      },
      {
        title: "Production Readiness and Final Audit",
        slug: "production-readiness-final-audit",
        description:
...

  {
    ...
    portfolio: {
      ...
      liveUrl: "https://novashad-v01.vercel.app",
      repositoryUrl: "https://github.com/devkiddz/novashad-v01",
      featured: false,
    ...
    technologies: [
      ...
      { name: "next-themes", slug: "next-themes" },
    ],
    milestones: [
      {
        title: "Dashboard Component System",
        slug: "dashboard-component-system",
        description:
      ...
      {
        title: "Theme and Data Presentation",
        slug: "theme-and-data-presentation",
        description:
      ...
      },
      {
        ...
        sortOrder: 3,
        completedAt: "2026-05-15",
        gitCommitSha: "2d95d50526707d52cd3100b47f2d8b95fac47964",
        completionNotes:
...

  {
    ...
    portfolio: {
      ...
      repositoryUrl: "https://github.com/devkiddz/NovaPanel-v01",
      featured: false,
    },
    technologies: [
      { name: "Next.js", slug: "nextjs" },
    ...
    milestones: [
      {
        title: "Next.js and Shared UI Foundation",
        slug: "nextjs-shared-ui-foundation",
        description:
      ...
      {
        title: "Theme and Navigation Prototype",
        slug: "theme-navigation-prototype",
        description:
        ...
        gitCommitSha: "541d875188b5036b6f1d13b39c156f33a2c22915",
        completionNotes:
...

  {
    ...
    milestones: [
      {
        title: "M03 — Rcentz UI Canvas & Design System",
        slug: "m03-rcentz-ui-canvas-design-system",
        description:
        ...
        gitCommitSha: "f880aa93f9423b7e572f6a424148332cfbc09252",
        gitTag: "m03-ui-canvas-v1",
        completionNotes:
          "Verified Rcentz milestone with an annotated Git tag marking the completed UI Canvas foundation.",
      },
      {
        title: "M04 — Database Foundation",
        slug: "m04-database-foundation",
        description:
